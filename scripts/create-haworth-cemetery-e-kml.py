...
# Create St Michael and All Angels's Church Graveyard Section E
#
...
#
# example:
# create-haworth-cemetery-e-kml.py -f "/home/foo/bar.csv" -o -1.9565800 -a 53.8312000 > graves-section-e.kml
#
...
LONG_SIX_INCES = 0.0000023
LAT_3FEET = 0.0000083
LAT_2FEET = 0.0000050
LAT_1FEET = 0.0000020
LAT_SIX_INCHES = 0.0000010

ADJUSTMENT_ANGLE = 175     # degrees counter-clockwise to rotate
...
def main(argv):
    ...
    try:
        ...
        print 'create-haworth-cemetery-e-kml.py -f <filepath> -o <long start> -a <lat start>'
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print 'create-haworth-cemetery-e-kml.py -f <filepath> -o <long start> -a <lat start>'
