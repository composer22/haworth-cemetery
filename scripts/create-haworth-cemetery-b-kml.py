...
# Create St Michael and All Angels's Church Graveyard Section B
#
...
#
# example:
# python  create-haworth-cemetery-b-kml.py -f "/home/foo/graves-section-b.csv" s-o -1.9562000 -a 53.8309440
#
...
def main(argv):
    ...
    try:
        ...
        print 'create-haworth-cemetery-kml-b.py -f <filepath> -o <long start> -a <lat start>'
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print 'create-haworth-cemetery-kml-b.py -f <filepath> -o <long start> -a <lat start>'
