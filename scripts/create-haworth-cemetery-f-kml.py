...
# Create St Michael and All Angels's Church Graveyard Section F
#
# Section F is the interior of the church.
#
...
#
# example:
# create-haworth-cemetery-f-kml.py -f "/home/foo/bar.csv" -o -1.9562000 -a 53.8311300 > graves-section-f.kml
#
